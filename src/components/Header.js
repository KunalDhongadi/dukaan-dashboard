  ...
  return (
    <header className="bg-white z-20 border-b border-[#D9D9D9] w-full sticky top-0">
      <div className="max-w-6xl mx-auto grid grid-cols-3 gap-3 w-full bg-white h-16 py-3 px-3 sm:px-8">
          ...
          <div className="lg:hidden pe-1 cursor-pointer">
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M0.0996094 4.7479C0.0996094 4.46349 0.330172 4.23293 0.614585 4.23293H12.2015C12.486 4.23293 12.7165 4.46349 12.7165 4.7479C12.7165 5.03232 12.486 5.26288 12.2015 5.26288H0.614585C0.330172 5.26288 0.0996094 5.03232 0.0996094 4.7479Z"
                fill="#4D4D4D"
              />
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M0.0996094 0.885582C0.0996094 0.601168 0.330172 0.370605 0.614585 0.370605H12.2015C12.486 0.370605 12.7165 0.601168 12.7165 0.885582C12.7165 1.17 12.486 1.40056 12.2015 1.40056H0.614585C0.330172 1.40056 0.0996094 1.17 0.0996094 0.885582Z"
                fill="#4D4D4D"
              />
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M0.0996094 8.61022C0.0996094 8.32581 0.330172 8.09525 0.614585 8.09525H12.2015C12.486 8.09525 12.7165 8.32581 12.7165 8.61022C12.7165 8.89464 12.486 9.1252 12.2015 9.1252H0.614585C0.330172 9.1252 0.0996094 8.89464 0.0996094 8.61022Z"
                fill="#4D4D4D"
              />
            </svg>
          </div>
          <p className="pe-2">Payments</p>
          <svg
            width="14"
            height="14"
            viewBox="0 0 14 14"
        ...
        <button className="flex gap-3 ml-auto">
